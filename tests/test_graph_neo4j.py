...
@pytest.mark.integration
@pytest.mark.requires_docker
def test_upsert_author_via_api(graph_db_url):
...
@pytest.mark.integration
@pytest.mark.requires_docker
def test_upsert_work_via_api(graph_db_url):
...
@pytest.mark.integration
@pytest.mark.requires_docker
def test_link_author_work_via_api(graph_db_url):
...
@pytest.mark.integration
@pytest.mark.requires_docker
def test_collaborator_discovery_via_api(graph_db_url):
    """GET /authors/{id}/collaborators should return co-authors via our service."""
    author1 = load_test_author(0)
    author2 = load_test_author(1)
    work = load_test_work(0)
...
@pytest.mark.integration
@pytest.mark.requires_docker
def test_viz_network_via_api(graph_db_url):
