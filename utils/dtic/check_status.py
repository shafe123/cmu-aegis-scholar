...
def check_vector_db(base_url: str = "http://localhost:8002", collection: str = "aegis_vectors"):
...
def main():
    ...
    if db_ok:
        ...
        print("  2. Check logs: docker compose -f dev/docker-compose.yml logs vector-loader")
