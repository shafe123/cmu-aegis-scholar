...
def test_parallel(num_publications=10, num_workers=4):
    ...
    print("=" * 60)
    print(f"TESTING: Parallel scraper - {num_workers} workers, {num_publications} publications")
    print("=" * 60)
...
def main():
    ...
    print(f"Parallel (4):     {parallel_per_pub:.2f} sec/publication ({single_time/parallel_per_pub:.1f}x faster)")
    print()
